...
const autodictC = [
    ...
    { key: "...START fformáz", value: "●●●START", tag: "●●●START" },
    { key: "...END fformáz", value: "●●●END", tag: "●●●END" },
    { key: ">START fformáz", value: "▶START", tag: "▶START" },
    { key: ">END fformáz", value: "▶END", tag: "▶END" },
    { key: "...DOCSTART fformáz", value: "●●●DOCSTART", tag: "●●●DOCSTART" },
    { key: "...DOCEND fformáz", value: "●●●DOCEND", tag: "●●●DOCEND" },
    //Nerdamer Constants
    ...
    { key: "kconvuluctionszorzat  vecktor nerd", value: "conv({c},,[röv])", tag: "<b>a</b>*<b>b</b> (konv.)" },
    { key: "kconvuluctioninversze  vecktor nerd", value: "convinv({c})", tag: "<b>a</b><sup> -&lowast;</sup> (röv.konv. inverz)" },
    ...
    { key: "truncprodszorzat calculusanalízis nerd", value: "truncprod(f{c},g,Nev,[n])", tag: "f&nbsp;&bullet;<sub>n</sub>&nbsp;g" },
